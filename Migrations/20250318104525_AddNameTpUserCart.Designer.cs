...
namespace BikeVille.Migrations
{
    ...
    [Migration("20250318104525_AddNameTpUserCart")]
    partial class AddNameTpUserCart
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BikeVille.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("BikeVille.Models.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("BikeVille.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("BikeVille.Models.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID")
            ...
            modelBuilder.Entity("BikeVille.Models.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("BikeVille.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("BikeVille.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BikeVille.Models.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("BikeVille.Models.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BikeVille.Models.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnType("int")
                        .HasColumnName("ProductModelID")
            ...
            modelBuilder.Entity("BikeVille.Models.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BikeVille.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BikeVille.Models.UserCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BikeVille.Models.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("BikeVille.Models.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("BikeVille.Models.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("BikeVille.Models.CustomerAddress", b =>
                {
                    b.HasOne("BikeVille.Models.Address", "Address")
                        .WithMany("CustomerAddresses")
                        .HasForeignKey("AddressId")
                        .IsRequired();

                    b.HasOne("BikeVille.Models.Customer", "Customer")
                        .WithMany("CustomerAddresses")
            ...
            modelBuilder.Entity("BikeVille.Models.Product", b =>
                {
                    b.HasOne("BikeVille.Models.ProductCategory", "ProductCategory")
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("BikeVille.Models.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("BikeVille.Models.ProductCategory", b =>
                {
                    b.HasOne("BikeVille.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("BikeVille.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("BikeVille.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("BikeVille.Models.SalesOrderDetail", b =>
                {
                    b.HasOne("BikeVille.Models.Product", "Product")
                        .WithMany("SalesOrderDetails")
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("BikeVille.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("BikeVille.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("BikeVille.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("BikeVille.Models.Address", "ShipToAddress")
